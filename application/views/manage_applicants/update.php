...
<script>
	$(document).ready(function() {
		...
		function init() {
			...
			$("#eligibility").val(formData.eligibility);
			$("#positionDesignation").val(formData.position_designation);
			$("#salaryGrade").val(formData.salary_grade);
			$("#placeOfAssignment").val(formData.place_of_assignment);
			$("#statusOfAppointment").val(formData.status_of_appointment);
			$("#educationAttainment").val(formData.education_attainment);
			$("#dateOfLastPromotion").val(formData.date_of_last_promotion);
			$("#lastestIPCR").val(formData.latest_IPCR_rating);
