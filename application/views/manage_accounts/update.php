...
<section>
	...
	<input type="hidden" id="formInput" value='<?= $formInput ?>'>
					...
					<form action="" class="mt-3">
						...
						<div class="row">
							...
							<div class="form-group col-md-4">
								...
								<select name="" id="penroDd" class="form-control" disabled>
									<option value="" id="penroDdSelectedOption">Select PENRO/CENRO/Regional Office</option>
								</select>
							</div>
						...
						<div class="row" id="tableOfficeCollection">
							...
							<div class="form-group col-md-6">
								...
								<center><button class="btn btn-primary col-md-8 mt-5" align="center" type="submit">Update</button></center>
							</div>
						</div>

						<script src="<?= base_url() ?>assets/custom_js/manage-account-update.js"></script>
