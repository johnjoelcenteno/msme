...
<section class="ml-5 mt-5">
    <h3>
        <a href="<?= base_url() ?>UserAccounts/create">
            <button class="btn btn-info float-right btn-sm"><i class="material-icons">add</i> Add Member</button>
        </a>
        ...
        $('#grid').kendoGrid({
            ...
            dataSource: {
                ...
                transport: {
                    ...
                    destroy: {
                        url: "<?= base_url() ?>ManageEmployees/destroy",
                        contentType: "application/json",
                        type: "POST"
                    },
                    create: {
